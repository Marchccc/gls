...
class ShipmentRequestBuilder implements ShipmentRequestBuilderInterface
{
    ...
    public function setRecipientName3(string $name3 = null) {
        $this->data['recipientAddress']['name3'] = $name3;
        return $this;
    }
    ...
    public function create(): \JsonSerializable
    {
        ...
        if (!empty($shipperAddress)) {
            ...
            $shipper->setName3($shipperAddress['name3'] ?? '');
        ...
        if (!empty($recipientAddress)) {
            ...
            $recipient->setName3($recipientAddress['name3'] ?? '');
